...
urlpatterns = patterns('',
    ...
    url(r'^entries/json/(?P<year>\d+)/(?P<month>\d+)/?$', login_required(views.FriendEntriesJSONView.as_view()), name='readingmonitor'),
    url(r'^entries/csv/(?P<year>\d+)/(?P<month>\d+)/?$', login_required(views.FriendEntriesCSVView.as_view()), name='readingmonitor'),
