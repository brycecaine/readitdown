...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'admin@readitdown.com'
EMAIL_HOST_PASSWORD = os.environ['RD_EMAIL_PW']
DEFAULT_FROM_EMAIL = 'admin@readitdown.com'

ACCOUNT_ACTIVATION_DAYS = 30
REGISTRATION_DEFAULT_FROM_EMAIL = 'admin@readitdown.com'
